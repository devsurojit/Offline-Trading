      ...
      <h5 class="mb-0">
		...
		<div class="form-row">
					...
					<div class="form-group col-md-3 mb-3 bmd-form-group is-focused">
						...
						<select class="form-control select2-hidden-accessible" data-style="btn btn-link" id="part_type" name="part_type"  required="true" tabindex="-1" aria-hidden="true" onchange="load_party();">
                    ...
                    <div class="form-group col-md-3 mb-3 bmd-form-group is-focused">
						...
						<select class="form-control select2-hidden-accessible" data-style="btn btn-link" id="party_id" name="party_id"  required="true" tabindex="-1" aria-hidden="true">
...
?>
 <script src="../assets/js/rpt_party_ledg.js"></script>
