      ...
      <div class="card-body">
		...
		<input type="hidden" id="tbl_data" name="tbl_data">
				<div class="form-row">
                    ...
                    <div class="form-group col-md-2 mb-2 bmd-form-group is-focused" id="wh_div">
						<label class="bmd-label-floating">Select Type</label>
						<select class="form-control select2-hidden-accessible" data-style="btn btn-link" id="part_Type" name="part_Type" tabindex="-1" aria-hidden="true" onchange="load_party();">
					...
					<div class="form-group col-md-2 mb-2 bmd-form-group is-focused" id="wh_div">
						...
						<select class="form-control select2-hidden-accessible" data-style="btn btn-link" id="pparty_Id" name="pparty_Id" tabindex="-1" aria-hidden="true" >
					...
					<div class="form-group col-md-2 mb-2 is-focused bmd-form-group">
					<label class="bmd-label-floating">Enter Bank Charge</label>
					<input type="text" class="form-control" id="bnk_crg" disabled autocomplete="off" required="true" name="bnk_crg">
					</div>
...
?>
 <script src="../assets/js/party_trans.js"></script>
