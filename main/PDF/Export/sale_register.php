...
class hdr1  extends TCPDF {
	public function Header() {
        ...
        $start_Date = $_SESSION['pRpt_saler_fdate'];
        $to_Date = $_SESSION['pRpt_saler_tdate'];
        ...
        $this->Cell(0,5, 'Billwise Sale Register From '. date("d-M-Y",strtotime($_SESSION['pRpt_saler_fdate'])) .' To '. date("d-M-Y",strtotime($_SESSION['pRpt_saler_tdate'])) .' ',0,0,'C' );
...
$gross_amt=0;
$net_amt=0;
foreach (qry_lst_out("Call USP_RPT_SALE_REGISTER('". $_SESSION['pRpt_saler_fdate'] ."','". $_SESSION['pRpt_saler_tdate'] ."',". $_SESSION['pRpt_sale_whare'] .",". $_SESSION['branch_id'] .");") as $row ) {
...
$pdf->Output('SALE_REGISTER_'. date("d-M-Y",strtotime($_SESSION['pRpt_saler_fdate'])) .'_'. date("d-M-Y",strtotime($_SESSION['pRpt_saler_tdate'])) .''.'.pdf', 'I');