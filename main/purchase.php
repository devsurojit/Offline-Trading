  ...
  <div class="card card-collapse">
    ...
    <div class="form-check-inline">
      <label class="form-check-label" for="radio1" style="color: white;font-weight: 600;">
        <input type="radio" class="form-check-input" id="chalan_opt" name="pur_mode"  checked onchange="pur_mode_select(this.id);" >From Chalan
      </label>
    </div>
    <div class="form-check-inline">
      <label class="form-check-label" for="radio2" style="color: white;font-weight: 600;">
        <input type="radio" class="form-check-input" id="non_chalan_opt" name="pur_mode" onchange="pur_mode_select(this.id);">With Out Chalan
      </label>
    </div>
    </div>
      ...
      <div class="card-body">
		...
		<input type="hidden" id="tbl_data" name="tbl_data">
				<div class="form-row">
					...
					<div class="form-group col-md-2 mb-2 is-focused bmd-form-group">
					<label class="bmd-label-floating">Reference Purchase No</label>
					...
					<div class="form-group col-md-4 mb-4 bmd-form-group is-focused" id="party_div">
						...
						<select class="form-control select2-hidden-accessible" data-style="btn btn-link" id="Party_Idd" name="Party_Idd" tabindex="-1" aria-hidden="true">
...
<div class="card">
<div class="card-header p-3 card-header-primary">
	<h4 class="mb-0">Add Item </h4>
	<div class="form-check-inline">
      <label class="form-check-label" for="radio1" style="color: white;font-weight: 600;">
        <input type="radio" class="form-check-input" id="gst_opt" name="gst_check"  checked >With GST
      </label>
    </div>
	<div class="form-check-inline">
      <label class="form-check-label" for="radio1" style="color: white;font-weight: 600;">
        <input type="radio" class="form-check-input" id="non_gst_opt" name="gst_check"  >With Out GST
      </label>
    </div>
</div>
<div class="card-body">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3 mb-3 bmd-form-group is-focused" id="chalan_div">
						<label class="bmd-label-floating">Select Chalan</label>
						<select class="form-control select2-hidden-accessible" data-style="btn btn-link" id="chalan_id" name="chalan_id" tabindex="-1" aria-hidden="true">
						<option value="" selected="" disabled="" >Select Chalan</option>						
                </select>
					...
					<input type="text" class="form-control" id="Itm_Qny" name="Itm_Qny" autocomplete="off">
					</div>
...
<div class="card-body">
				...
				<table id="faqs" class="table table-strip">
					<thead>
						<tr>
							<th>SL</th>
							<th style="display:none;">chalan_Id</th>
                            ...
                            <th style="display:none;">pur_gl_Id</th>
...
The GST Act has defined time limit to issue GST tax invoice, revised GST bill, debit note, and credit note.  <br> Following are the due dates for issuing an invoice to customers</p>
					...
					<div class="row">
						...
						<div class="col-sm-9" style="padding-right: 15.5%;">
							...
							<input type="text" class="form-control decimal text-right" style="font-size: 16px;" id="disc_value" name="disc_value" autocomplete="off" onkeyup="cal_tot_amt();" placeholder="0.00">
							<span class="bmd-help"></span>
							</div>
						</div>
					</div>
					<div class="row">
						<label class="col-sm-3 col-form-label">TCS: (+) </label>
						<div class="col-sm-9" style="padding-right: 15.5%;">
							<div class="form-group bmd-form-group is-filled">
							<input type="text" class="form-control decimal text-right " style="font-size: 16px;" id="tcs_value" name="tcs_value" autocomplete="off" onkeyup="cal_tot_amt();" placeholder="0.00">
							<span class="bmd-help"></span>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-9" style="padding-right: 15.5%;">
							...
							<input type="text" class="form-control text-right " style="font-size: 16px;" id="round_value" name="round_value" onkeyup="cal_tot_amt();" autocomplete="off"  placeholder="0.00">
							<span class="bmd-help"></span>
							</div>
						</div>
					</div>
				...
				<div class="row" style="font-weight:400; font-size:16px; color:#000;">
					...
					<div class="row">
						...
						<div class="col-sm-9">
							...
							<input type="hidden" id="org_tot" name="org_tot" value="0">
...
<div class="card-body">	
    <div class="row">				
        ...
        <label class="form-check-label" for="radio1" style="font-weight: 600;">
            <input type="radio" class="form-check-input" id="cash_opt" name="trans_opt" value="cash" checked onchange="trans_mode(this.id);">Cash
        </label>
        </div>
        <div class="form-check-inline">
        ...
        <div class="form-group col-md-3 mb-3 bmd-form-group is-focused" id="bank_div">
            ...
            <select class="form-control select2-hidden-accessible" data-style="btn btn-link" id="bank_Id" name="bank_Id" tabindex="-1" aria-hidden="true">
    ...
    <div class="row justify-content-center">
		...
		<button type="button" class="btn btn-info btn-sm btn-block text-white"  id="save_btn" onclick="post_purchase();">Save</button>
        </div>	
    </div>
</div>
...
?>
 <script src="../assets/js/purchase_process.js"></script>
