...
<h4 class="card-title">Product Stock Summery  <span style="margin-left: 410px;">As On: <?php echo date_format(date_create(date("Y-m-d")),"d-m-Y"); ?></span> <span style="float: right;" id="ware_h">Whare  House :</span></h4>
</div>
<div class="card-body">
<div class="toolbar">
...
<tr role="row">
    ...
    <th class="sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 308px;" aria-label="Bill No: activate to sort column ascending">Item Name</th>
    <th class="sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 159px;" aria-label="Customer Name: activate to sort column ascending">Unit</th>
    <th class="sorting" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 159px;" aria-label="Created At: activate to sort column ascending">Qnty</th>
...
?>
 <script>
  ...
  <script src="../assets/js/product_stock.js"></script>
<?php
}
else{
