...
function view_report(){
    ...
    if(frm_date==''){
        ...
        $.ajax({
            type: "POST",
            url: "method/ajax.php",
            data: {pItemWise_GST_fd:frm_date,pItemwise_GST_td:td_date,pItemwise_GST_whare:whare_h,pItemwise_GST_cat:pItem_Cat,pItemwisep_GST_unit:pItem_Unit,pItemwise_GST_cat_name:pItem_cat_name},
            success: function (response) {
                window.open(location.protocol + '//' + location.hostname + '/trading/main/PDF/Export/gst_sale_summery.php',"PDF Report","_blank","fullscreen=yes");
            }
        });
